...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // Si el token está expirado, simplemente lo ignoramos y continuamos.
            ...
            // Otros errores de token (malformado, etc.)
            System.out.println("Error en el token JWT: " + e.getMessage());
        }
